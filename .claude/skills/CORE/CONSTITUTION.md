...
**The Foundational Philosophy, Architecture, and Operations of Jean-Marc Giorgi's Personal AI Infrastructure**

**Last Updated:** 2025-11-19
**Status:** Active - This is the canonical reference for all Qara architectural decisions
...
**THE MOST IMPORTANT ARCHITECTURAL PATTERN IN QARA**
...
**The building blocks of Qara's architecture.**
...
- Profile-based configuration in Qara
...
**See [Two-Tier MCP Strategy](#two-tier-mcp-strategy) for Qara's approach to MCPs.**
...
**Qara's 12+ Specialized Agents:**

| Agent                 | Purpose | Voice ID |
|-----------------------|---------|----------|
| qara                    | Main orchestrator, delegates tasks | s3TPKV1kjDlVtZbl4Ksh |
...
```
Qara → Engineer → Implementation complete
```

**Parallel Delegation:**
```
Qara → [Intern1, Intern2, Intern3] → All complete → Qara synthesizes
```

**Nested Delegation:**
```
Qara → Architect (designs) → Engineer (implements) → Qara verifies
```

**Spotcheck Pattern:**
```
Qara → [10 Interns update files] → Spotcheck Intern (verifies all 10)
```
...
│   ├── CORE/                        # Qara identity + infrastructure
│   │   ├── SKILL.md                 # Main Qara skill (Tier 2)
...
### The Ten Commandments of Qara Architecture
...
**These are non-negotiable foundations that ensure Qara remains dependable, maintainable, and effective.**
...
**This document defines what Qara is and how Qara works at the most fundamental level.**
