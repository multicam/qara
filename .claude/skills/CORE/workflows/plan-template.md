...
- Use `make` whenever possible instead of direct commands
- Example: `make -C humanlayer-wui check` instead of `cd humanlayer-wui && bun run fmt`
- This ensures consistency with project build system
