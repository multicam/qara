...
| Charcoal | #2D2D2D | Qara signature, subtle details                 |
...
7. **NO TEXT** (except Qara signature)
8. **QARA SIGNATURE:** Small subtle "Qara" in charcoal (#2D2D2D) bottom right
...
Sign "Qara" small in charcoal (#2D2D2D) bottom right corner.
NO other text.
```
