...
// Mode/TDD types and functions extracted to miner-mode-lib.ts
export {
    parseModeChanges,
    computeModeMetrics,
    parseTDDEnforcement,
...
// parseModeChanges, computeModeMetrics, parseTDDEnforcement, computeTDDMetrics
// → extracted to miner-mode-lib.ts, re-exported at top of file

// ---------------------------------------------------------------------------
// Exports (trace-specific only; mode/TDD re-exported above)
// ---------------------------------------------------------------------------
