---
name: create-skill
description: Guide for creating new skills in Qara's personal AI infrastructure. Use when user wants to create, update, or structure a new skill that extends capabilities with specialized knowledge, workflows, or tool integrations. Follows both Anthropic skill standards and PAI-specific patterns.
---
...
- User wants to extend Qara's capabilities
...
Update `${PAI_DIR}/global/QARA.md` available_skills section to include the new skill so it shows up in the system prompt.
