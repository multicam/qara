...
context: fork
description: |
  Prompt engineering and context engineering principles based on Anthropic best practices.
  USE WHEN: "create a prompt", "prompt engineering", "optimize this prompt", "context engineering".
---
