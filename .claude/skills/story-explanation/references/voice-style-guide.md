...
- Stick to the facts - don't extrapolate
...
**N sentences** (user-specified, default 25) with inline links:
...
1. **Mode collapse** - Only considering obvious narrative framings
2. **Formulaic structure** - Generic academic or journalistic tone
3. **Cliche language** - Using "game-changer", "paradigm shift", etc.
4. **Extrapolating** - Adding information not in source content
5. **Wrong voice** - Third person, formal, or academic
6. **No "wow" factor** - Missing compelling closing
7. **Bullet points** - Using lists in final output
8. **Flowery language** - Emotional or hyperbolic tone

## Success Criteria

- Story reads naturally when spoken aloud
