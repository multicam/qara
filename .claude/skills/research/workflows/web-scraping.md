...
Web scraping and crawling using WebFetch. Includes HTML parsing, rate limiting, and best practices for ethical scraping.
...
2. **CAPTCHA/blocking?** → Use retrieve workflow
## Common Tasks
