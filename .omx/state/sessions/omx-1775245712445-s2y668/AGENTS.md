...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775245712445-s2y668 | 2026-04-03T19:48:32.803Z

**Codebase Map:**
  purgatory/: checkpoint-utils, datetime-utils, jsonl-utils, transcript-utils, pre-tool-use-security, postcss.config, useAgentChartData, useChartData, useEventColors, useEventEmojis
  .claude/: config-change.test, config-change, cli.test, cli, graph, scanner, types, datetime-utils.test, datetime-utils
